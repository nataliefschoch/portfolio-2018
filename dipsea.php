      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-8'>
            <div>
              <p>
                <span class='bold'>Dipsea Onboarding flow</span>
                <span class='block'>UX &amp; visual design</span>
              </p>              
              <p class='padding-top-15px'>
              Dipsea is the first audio platform for sexual wellness. It provides short and sexy audio stories made for women. I worked with Dipsea to create an onboarding experience for new users and trial subscribers. The goal of the onboarding flow was to educate users, create a high-touch and personalized experience, and increase content discoverability.
              </p>
              <p class='padding-top-15px'>
              ...
              <p class='padding-top-15px'>
                ...
                <a class='block', href='https://dipseastories.com'>Dipsea</a>
              </p>
            </div>
          </div>
        </div>
