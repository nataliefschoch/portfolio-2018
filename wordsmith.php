      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-8'>
            <div>
              <p>
                <span class='bold'>Wordsmith&mdash;Chrome Extension</span>
              ...
              <p class='padding-top-15px'>
                ...
                <a class='block', target='_blank' href='https://chrome.google.com/webstore/detail/wordsmith/gnpnpeephndoppbobdbpigepfdklacbp'>Chrome Extension Store</a>
              </p>
            </div>
          </div>
        </div>
