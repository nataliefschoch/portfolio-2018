...
<body>  
  ...
  <div class='work gusto-careers'>
      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-6 col-md-offset-3'>
            ...
            <p>
              <span class='small-caps text-center'>
                Goals of the redesign:
              </span>
              <ol>
                <li>
                  <p>Represent Gusto's brand</p>
                </li>
                <li>
                  <p>Spotlight the company's commitment to diversity and belonging</p>
                </li>
                <li>
                  <p>Improve the candidate user experience</p>
                </li>
              </ol>
            </p>
          </div>
    ...
    <section>
      <img src='../images/img-work-gusto-careers--photography.jpg', class='img-responsive', alt='Gusto Careers Photography', title='Gusto Careers Photography'/>
    </section>
      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-5 text-left'>
            <img src='../images/img-work-gusto-careers--affinity-badges.gif', class='img-responsive', alt='Gusto Careers Photography', title='Gusto Careers Photography'/>
          </div>
